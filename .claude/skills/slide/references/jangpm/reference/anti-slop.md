# Anti-Slop Reference: 18 Forbidden Patterns

Patterns that must never appear in generated slides. For each rule: what is forbidden, what to use instead, and why.
...
/* Result: purple-tinted everything, no visual hierarchy */
```

**Correct alternative:**
```css
/* Default: white/surface backgrounds. Accent is rare and intentional. */
...
// Forbidden — Chart.js cannot resolve CSS variables at paint time
data: {
  datasets: [{
...
// Forbidden — multiple distinct hues
backgroundColor: [
