...
//
// 사용법:
//   node .claude/skills/theme-init/scripts/gen-theme-preview.mjs <theme>
//   node .claude/skills/theme-init/scripts/gen-theme-preview.mjs <theme> --all
//   node .claude/skills/theme-init/scripts/gen-theme-preview.mjs <theme> --patterns 01-title.html,12-closing.html
//
...
const themeDir = resolve(ROOT, '.claude/skills/slide/references', theme);
