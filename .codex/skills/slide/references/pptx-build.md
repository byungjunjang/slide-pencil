...
스크립트 위치: `.codex/skills/slide/scripts/`
...
```bash
node .codex/skills/slide/scripts/html2pptx.mjs "output/{slug}/{slug}.html"   # [--max-diff 0.08] [--retries 2]
...
**2.5.1 — 스크립트 검증 실행:**
```bash
node .codex/skills/slide/scripts/check-manifest.js "output/{제목}/{제목}-manifest.json"
```
...
# 명시적 지정도 가능 (2번째 인자)
node .codex/skills/slide/scripts/convert.js "output/{제목}/{제목}-manifest.json" "output/{제목}/{제목}.pptx"
```
