...
SRC_TOKEN = ".codex/skills"
DST_TOKEN = ".codex/skills"
MARKER_NAME = "_GENERATED.md"
MARKER_BODY = (
    "# GENERATED — DO NOT EDIT\n\n"
    "이 트리는 `.codex/skills/slide/scripts/dev/sync_codex_mirror.py`의 생성물입니다.\n"
    "직접 편집하지 마세요. `.codex/skills`를 수정한 뒤 sync를 재실행하세요:\n\n"
    "    python .codex/skills/slide/scripts/dev/sync_codex_mirror.py\n"
)
